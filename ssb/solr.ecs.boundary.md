...
Rel(solr_client, solr_leader_ingress, "update SolrCloud instance", "https POST (443)")
Rel(solr_client, solr_follower_ingress, "query SolrCloud instance", "https GET (443)")
...
Rel(solr_followers, solr_leader_ingress, "retrieves updates", "https GET (443)")
